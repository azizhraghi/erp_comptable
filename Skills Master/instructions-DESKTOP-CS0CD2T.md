...
- `[N]` : numéro à 2 chiffres minimum (V01, V02... V10, V11...)
...
| 6 | Managing-versions | Invoquer après CHAQUE livraison — met à jour les 3 fichiers TXT |
...
| 4. Suivi versions | `.agent/skills/managing-versions/SKILL.md` | Après chaque livraison de code |
